...
{
    public class ServiceErrorReponse : IResponse
    {

        public ServiceErrorReponse(string requestId)
        {
            RequestId = requestId;

            //, string message, ICollection<ServiceError> errors
            //Message = message;
        ...
        public IEnumerable<ServiceError> ServiceErrors { get; set; }
